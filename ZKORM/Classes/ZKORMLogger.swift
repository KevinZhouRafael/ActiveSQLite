...
public class Log{
    static func d(_ message: Any = "",
        ...
        if ZKORMConfigration.logLevel == .debug {
    ...
    static func i(_ message: Any = "",
                 ...
                 line: Int = #line,
                 function: String = #function) {
        if ZKORMConfigration.logLevel.rawValue >= LogLevel.info.rawValue {
    ...
    static func w(_ message: Any = "",
                 ...
                 line: Int = #line,
                 function: String = #function) {
        if ZKORMConfigration.logLevel.rawValue >= LogLevel.warn.rawValue {
